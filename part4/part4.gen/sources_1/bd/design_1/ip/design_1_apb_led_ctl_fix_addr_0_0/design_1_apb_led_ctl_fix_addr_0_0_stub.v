...
// Date        : Tue Apr 29 06:15:06 2025
// Host        : DESKTOP-F3DSQKO running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top design_1_apb_led_ctl_fix_addr_0_0 -prefix
//               design_1_apb_led_ctl_fix_addr_0_0_ design_1_apb_led_ctl_fix_addr_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_apb_led_ctl_fix_addr_0_0,apb_led_ctl,{}" *) (* CORE_GENERATION_INFO = "design_1_apb_led_ctl_fix_addr_0_0,apb_led_ctl,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=apb_led_ctl_fix_addr,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "package_project" *) (* X_CORE_INFO = "apb_led_ctl,Vivado 2024.2" *) 
module design_1_apb_led_ctl_fix_addr_0_0(rst, clk, paddr, psel, penable, pwrite, pready, 
