namespace eval ::optrace {
  variable script "C:/Vivado/part4simple/part4simple.runs/impl_1/design_1_wrapper.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/Vivado/part4simple/part4simple.cache/wt [current_project]
