...
HD_PWD='C:/Vivado1/part3/part3.runs/design_1_apb_led_ctl_fix_addr_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_apb_led_ctl_fix_addr_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_apb_led_ctl_fix_addr_0_0.tcl
