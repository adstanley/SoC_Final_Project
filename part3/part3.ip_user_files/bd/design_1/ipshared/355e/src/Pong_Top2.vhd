...
entity Pong_Top2 is
  ...
  port (
    ...
    o_Ball_X_Dir_2 : out std_logic;
    o_Ball_Y_Dir_2 : out std_logic;
    o_Ball_Y_2     : out std_logic_vector(5 downto 0);
    o_P2_Paddle_Y  : out std_logic_vector(5 downto 0); 
...
architecture rtl of Pong_Top2 is
  ...
  signal w_Ball_X_Dir : std_logic;
  signal w_Ball_Y_Dir : std_logic;
...
--  end process p_Reg_Syncs; 
  ...
  Pong_Ball_Ctrl_inst : Pong_Ball_Ctrl
    port map (
      ...
      o_Ball_X        => w_Ball_X,
      o_Ball_Y        => w_Ball_Y,
      o_Ball_X_Dir    => w_Ball_X_Dir,
      o_Ball_Y_Dir    => w_Ball_Y_Dir
      );
  ...
  o_Ball_X_Dir_2 <= w_Ball_X_Dir;
  o_Ball_Y_Dir_2 <= w_Ball_Y_Dir;
  o_Ball_Y_2     <= w_Ball_Y;
  o_P2_Paddle_Y  <= w_Paddle_Y_P2;
