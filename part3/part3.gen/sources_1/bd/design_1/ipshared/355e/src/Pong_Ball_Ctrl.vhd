...
entity Pong_Ball_Ctrl is
  port (
    ...
    o_Ball_Y_Dir    : out std_logic;
    o_Ball_X_Dir    : out std_logic
    );
...
architecture rtl of Pong_Ball_Ctrl is
  ...
  signal r_Ball_X_Dir : std_logic;
  signal r_Ball_Y_Dir : std_logic;
...
begin
  ...
  o_Ball_X_Dir <= r_Ball_X_Dir;
  o_Ball_Y_Dir <= r_Ball_Y_Dir;
